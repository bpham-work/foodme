...
public class StoreService {
    ...
    private String GEOCODE_URI = "http://maps.googleapis.com/maps/api/geocode/json?&ey=AIzaSyAQTaJr3r2jm0PadmzUgFJZwqXz3GY7MS4&address=%s";
    ...
    public List<Store> getStores(String zip) {
            ...
            return results.parallelStream().map((Store::new)).collect(Collectors.toList());
    }
